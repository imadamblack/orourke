  ...
  return (
    <section className="relative flex flex-col flex-grow justify-center py-20 px-0">
      <div className="container md:w-1/2 flex flex-col items-center">
        <h2 className="ft-8 mb-12 text-center">
          ¡Gracias! Muy pronto estaremos platicando sobre tu proyecto de inversión
        </h2>
        <div className="flex flex-col items-center justify-center">
          <p className="text-center ft-2 mb-12">
            Si no se abrió nuestro calendario para agendar tu asesoría de inversión
          </p>
